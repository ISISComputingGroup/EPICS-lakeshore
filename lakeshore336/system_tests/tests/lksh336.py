...
class Lksh336Tests(unittest.TestCase):
    ...
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_kelvin_temperature_set_via_backdoor_THEN_input_kelvin_temperature_updates(
        self, _, input
    ):
    ...
    @parameterized.expand(parameterized_list(INPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_voltage_input_set_via_backdoor_THEN_input_voltage_input_updates(
        self, _, input
    ):
    ...
    @parameterized.expand(parameterized_list(INPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_alarm_status_set_via_backdoor_THEN_input_alarm_status_updates(
        self, _, input
    ):
    ...
    @parameterized.expand(parameterized_list(INPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_reading_status_set_via_backdoor_THEN_input_reading_status_updates(
        self, _, input
    ):
    ...
    @parameterized.expand(parameterized_list(OUTPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_output_heater_status_set_via_backdoor_THEN_output_heater_status_updates(
        self, _, output
    ):
    ...
    @parameterized.expand(parameterized_list(INPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_curve_number_set_via_backdoor_THEN_input_curve_number_updates(
        self, _, input
    ):
    ...
    @parameterized.expand(parameterized_list(INPUTS))
    @skip_if_recsim("Requires lewis backdoor")
    def test_WHEN_input_curve_header_set_via_backdoor_THEN_input_curve_header_updates(
        self, _, input
    ):
        self._lewis.backdoor_command(
            [
                "device",
                "set_input_curve_header",
                str(0),
                "name".rjust(15, "a"),
                "num".rjust(10, "a"),
                str(2),
    ...
    def test_WHEN_input_type_set_via_backdoor_THEN_input_type_updates(self, _, input):
        self._lewis.backdoor_command(
            ["device", "set_input_type", input, str(2), str(1), str(2), str(1), str(2)]
        )
